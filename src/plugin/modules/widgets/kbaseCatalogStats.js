    ...
    return $.KBWidget({
                            ...
                            $('<label>')
                                .append(
                                    $('<input>')
                                        ...
                                        .on('click', function(e) {
                                            var $target = $(e.target);
                                            var $container = $target.prop('tagName') === 'LABEL' ? $target : $target.parent();
        ...
        getAdminLatestRuns: function() {
            ...
            return self.metricsClient
                ...
                '</a>';
                            job.app_module_name =
                '<a href="#catalog/modules/' + appModule[0] + '" target="_blank">' + appModule[0] + '</a>';
                        } else if (job.method) {
                            var methodPieces = job.method.split('.');
                            job.app_id = '(API):' + methodPieces[1];
                            job.app_module_name =
                '<a href="#catalog/modules/' + methodPieces[0] + '" target="_blank">' + methodPieces[0] + '</a>';
                        } else {
                            job.app_id = 'Unknown';
