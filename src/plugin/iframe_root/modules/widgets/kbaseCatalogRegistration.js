        ...
        render: function () {
            ...
            if (self.options.registration_id) {
                ...
                if (self.options.show_title) {
                    ...
                    self.$inputPanel.append(
                        'For help with building and registering new KBase Apps, see the <a href="https://github.com/kbase/kb_sdk" target="_blank">KBase SDK</a><br><br>'
                    );
                }
                ...
                var $gitUrlInput = $(
                    '<input type="text" class="form-control" id="git_url" placeholder="e.g. https://github.com/msneddon/kb_megahit">'
                );
                var $commitInput = $('<input type="text" class="form-control" id="commit" placeholder="e.g. 15b6ec0">');

                var $git_url_group = $('<div>')
                    .addClass('form-group')
