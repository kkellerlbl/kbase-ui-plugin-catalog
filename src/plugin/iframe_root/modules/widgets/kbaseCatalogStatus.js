    ...
    $.KBWidget({
        ...
        renderControlPanel: function () {
            ...
            $filterModules.on('change', function () {
                ...
                self.getBuildStatus(self.options.skip, $setLimit.val(), modules).then(function () {
                    self.renderBuildList();
                });
            });
            var $filterModulesDiv = $('<div>')
                .addClass('form-group')
        ...
        renderBuildList: function () {
            ...
            for (var k = 0; k < self.build_list.length; k++) {
                self.$buildListPanel.append(self.renderBuildInfo(self.build_list[k]));
            }
        },
