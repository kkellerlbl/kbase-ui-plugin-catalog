define([
    ...
    $.KBWidget({
        ...
        setupClients: function () {
            ...
            this.wizard = new ServiceWizard(this.runtime.getConfig('services.service_wizard.url'), {
                token: this.runtime.service('session').getAuthToken()
            });
        },
        ...
        initMainPanel: function () {
            ...
            var $statusRefresh = $('<button>')
                .addClass('btn btn-default')
                .append($('<i class="fa fa-refresh" aria-hidden="true">'))
                .append('&nbsp;&nbspRefresh');
            $statusRefresh.on('click', function () {
